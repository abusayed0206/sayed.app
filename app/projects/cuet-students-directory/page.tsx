      ...
      <section className="py-8 border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-6">
            ...
            <span className="px-3 py-1 text-sm bg-neutral-100 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 rounded">supabase</span>
          ...
          <div className="flex justify-center gap-3">
            <a href="https://github.com/abusayed0206/cuet" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-sm border border-neutral-200 dark:border-neutral-800 rounded-md hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-colors">
              View Code →
            </a>
            <a href="https://cuet.sayed.app/" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-sm bg-neutral-900 text-white dark:bg-neutral-100 dark:text-neutral-900 rounded-md hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors">
              Live Demo →
            </a>
          </div>
        </div>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <div className="border border-neutral-200 dark:border-neutral-800 rounded-lg p-6 mb-6">
              <p className="text-neutral-600 dark:text-neutral-400 mb-4">
                CUET Students Directory is a comprehensive web application that provides easy access to the complete student directory of Chittagong University of Engineering & Technology.
              </p>
              
              <p className="text-neutral-600 dark:text-neutral-400">
                Built with Next.js, this platform offers a fast, sortable, and searchable interface for finding student information across all departments and batches.
              </p>
            </div>
            ...
            <div className="space-y-3 mb-6">
              <div className="border-l-4 border-neutral-900 dark:border-neutral-100 pl-4">
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1">Fast Search</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Quick search functionality to find students by name, ID, or department</p>
              </div>

              <div className="border-l-4 border-neutral-900 dark:border-neutral-100 pl-4">
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1">Sortable Data</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Sort students by various fields for easy organization</p>
              </div>

              <div className="border-l-4 border-neutral-900 dark:border-neutral-100 pl-4">
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1">Responsive Design</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Mobile-friendly interface for access on any device</p>
              </div>
            </div>
