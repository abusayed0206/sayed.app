...
export default function ProjectPage() {
  const gallery = ["/imgs/bangla-library.png","/imgs/bangla-library-ss1.png","/imgs/bangla-library-ss2.png"];
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col items-center gap-3 mb-4">
            ...
            <p className="text-sm sm:text-base text-neutral-600 dark:text-neutral-400 max-w-2xl">
              Desktop application for browsing & reading public-domain Bengali books from Wikisource.
            </p>
          </div>

          <p className="text-sm text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto mb-6 leading-relaxed">
            Fast, beautifully designed desktop application for Windows providing direct offline access to public-domain Bengali books from Wikisource with a customizable EPUB reader.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-1.5 mb-8">
            ...
            <span className="px-2.5 py-0.5 text-xs bg-neutral-200/60 dark:bg-neutral-800/60 text-neutral-700 dark:text-neutral-300 rounded-md">#epub</span>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <MicrosoftStoreBadge href="https://apps.microsoft.com/detail/9nj4lpwfw5rr?hl=en-US&gl=BD" />
        ...
        <div className="max-w-4xl mx-auto px-4 space-y-12">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-neutral-50 dark:bg-neutral-900/50 rounded-xl p-6 border border-neutral-200/80 dark:border-neutral-800/80 space-y-4 text-neutral-700 dark:text-neutral-300 leading-relaxed text-sm sm:text-base">
              <p>Bangla Library is a fast, beautifully designed desktop application tailored for Windows. It provides direct access to a vast collection of public-domain Bengali books digitized by Wikisource contributors.</p>
              <p>Once downloaded, books are available for offline reading. The built-in EPUB reader supports custom themes, font options, bookmarking, and progress tracking, providing a distraction-free experience for classic Bengali literature.</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm space-y-1.5">
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 text-sm sm:text-base">Offline Reading</h3>
                <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">Read downloaded books anytime without an active internet connection.</p>
              </div>

              <div className="p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm space-y-1.5">
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 text-sm sm:text-base">Customizable EPUB Reader</h3>
                <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">Choose themes, font sizes, line height, and bookmark favorite pages.</p>
              </div>

              <div className="p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm space-y-1.5">
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 text-sm sm:text-base">Wikisource Catalog</h3>
                <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">Explore thousands of public-domain Bengali literary classics and documents.</p>
              </div>

              <div className="p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm space-y-1.5">
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 text-sm sm:text-base">Reading Progress Tracking</h3>
                <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">Automatically saves your reading position across all downloaded books.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              ...
              <div className="p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/50">
                <span className="block text-xs text-neutral-500 dark:text-neutral-400 font-medium">Format Support</span>
                <span className="block text-sm font-semibold text-neutral-900 dark:text-neutral-100 mt-1">EPUB / Public Domain Books</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-neutral-900 dark:bg-neutral-100 text-white dark:text-neutral-900 text-center space-y-4">
            <h3 className="text-xl font-bold">Get Bangla Library from Microsoft Store</h3>
