      ...
      <section className="py-8 border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-3">
            <a href="https://github.com/abusayed0206/telegraphcms" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-sm border border-neutral-200 dark:border-neutral-800 rounded-md hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-colors">
              View Code 
            </a>
            <a href="https://telegraphcms.sayed.app/" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-sm bg-neutral-900 text-white dark:bg-neutral-100 dark:text-neutral-900 rounded-md hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors">
              Live Demo 
            </a>
          </div>
        </div>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <div className="border border-neutral-200 dark:border-neutral-800 rounded-lg p-6 mb-6">
              <p className="text-neutral-600 dark:text-neutral-400 mb-4">
                Telegraph CMS is a lightweight content management system that leverages the Telegraph API to provide a minimalist platform for creating and publishing articles. It offers a clean, distraction-free writing experience.
              </p>
              
              <p className="text-neutral-600 dark:text-neutral-400">
                Built with Next.js, this CMS focuses on simplicity and ease of use, making it perfect for bloggers and content creators who want a straightforward publishing platform.
              </p>
            </div>
            ...
            <div className="space-y-3 mb-6">
              <div className="border-l-4 border-neutral-900 dark:border-neutral-100 pl-4">
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1">Telegraph API Integration</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Seamless integration with Telegraph for content publishing</p>
              </div>

              <div className="border-l-4 border-neutral-900 dark:border-neutral-100 pl-4">
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1">Simple Interface</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Clean and intuitive UI for creating and managing content</p>
              </div>

              <div className="border-l-4 border-neutral-900 dark:border-neutral-100 pl-4">
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1">Fast Publishing</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Quick article creation and instant publishing</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              <div className="border border-neutral-200 dark:border-neutral-800 rounded-lg p-4">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Telegraph API</p>
              </div>

              <div className="border border-neutral-200 dark:border-neutral-800 rounded-lg p-4">
                <h4 className="text-sm font-semibold text-neutral-900 dark:text-neutral-100 mb-2">Type</h4>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Content Management System</p>
              </div>

              <div className="border border-neutral-200 dark:border-neutral-800 rounded-lg p-4">
                <h4 className="text-sm font-semibold text-neutral-900 dark:text-neutral-100 mb-2">Deployment</h4>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Vercel</p>
              </div>
            </div>
          </div>
        </div>
